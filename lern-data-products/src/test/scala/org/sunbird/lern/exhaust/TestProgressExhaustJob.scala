package org.sunbird.lern.exhaust
...
import org.sunbird.lern.exhaust.collection.{AssessmentData, CollectionBatch, CourseData, Metrics, ProgressExhaustJob}
import org.sunbird.lern.job.report.BaseReportSpec
import org.sunbird.lern.util.{BaseSpec, EmbeddedCassandra, EmbeddedPostgresql, RedisConnect}
...
class TestProgressExhaustJob extends BaseSpec with MockFactory with BaseReportsJob {
