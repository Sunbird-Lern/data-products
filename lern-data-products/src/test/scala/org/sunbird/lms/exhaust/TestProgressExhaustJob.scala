...
class TestProgressExhaustJob extends BaseReportSpec with MockFactory with BaseReportsJob {
  ...
  "ProgressExhaustReport" should "generate the report with all the correct data" in {
    ...
    val strConfig = """{"search":{"type":"none"},"model":"org.sunbird.lms.exhaust.collection.ProgressExhaustJob","modelParams":{"store":"local","mode":"OnDemand","batchFilters":["TPD"],"searchFilter":{},"sparkElasticsearchConnectionHost":"{{ sunbird_es_host }}","sparkRedisConnectionHost":"localhost","sparkUserDbRedisPort":6341,"sparkUserDbRedisIndex":"0","sparkCassandraConnectionHost":"localhost","fromDate":"","toDate":"","storageContainer":"","userCacheCols":["framework_board"],"reportColumnMapping":{"courseid":"Collection Id","collectionName":"Collection Name","batchid":"Batch Id","batchName":"Batch Name","userid":"User UUID","username":"User Name","usertype":"User Type","usersubtype":"User Sub Type","state":"State","district":"District","block":"Block","cluster":"Cluster","orgname":"Org Name","email":"Email ID","phone":"Mobile Number","consentflag":"Consent Provided","consentprovideddate":"Consent Provided Date","schooludisecode":"School Id","schoolname":"School Name"},"csvColumns":["courseid", "collectionName", "batchid", "batchName", "userid",  "state", "district", "orgname", "schooludisecode", "schoolname", "framework_board", "block", "cluster", "usertype", "usersubtype", "enrolleddate", "completedon", "certificatestatus", "completionPercentage"]},"parallelization":8,"appName":"Progress Exhaust"}"""
