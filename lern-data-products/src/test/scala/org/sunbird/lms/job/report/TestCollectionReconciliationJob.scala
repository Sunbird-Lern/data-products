...
import org.sunbird.lms.audit.CollectionReconciliationJob
import org.sunbird.lms.job.report.BaseReportSpec
import org.sunbird.core.util.{EmbeddedCassandra, UserData}
...
class TestCollectionReconciliationJob extends BaseReportSpec with MockFactory {
  ...
  it should "generate the report for all the batches" in {
    ...
    val strConfig = """{"search":{"type":"none"},"model":"org.sunbird.lms.audit.CollectionReconciliationJob","modelParams":{"mode":"prodrun","brokerList":"11.2.1.15:9092","topic":"sunbirddev.issue.certificate.request","sparkCassandraConnectionHost":"11.2.3.83"},"parallelization":30,"appName":"CollectionReconciliationJob"}""".stripMargin
