...
class TestETBMetricsJob extends SparkSpec(null) {
  ...
  "ETBMetricsJob" should "execute without any errors/exceptions" in {
    ...
    val con = JobConfig(Fetcher("none", None, None, None), None, None, "org.sunbird.lms.model.report.ETBMetricsModel", Option(modelParams), Option(Array(Dispatcher("console", Map("printEvent" -> false.asInstanceOf[AnyRef])))), Option(8), Option("ETB Metrics Model"), Option(false), None, None)
